  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype._calc = function() {
      ...
      if (this.elementWidth !== w || this.elementHeight !== h || this.dirty) {
        ...
        this.dirty = false;
        this.left = this.options.padding + this.options.paddingLeftExtra;
    ...
    Grid.prototype.drawGoal = function(goal, color) {
      ...
      this.raphael.path(path).attr('stroke', color).attr('stroke-width', this.options.goalStrokeWidth);
      idx = $.inArray(goal, this.options.goals);
      if (this.options.goalLabels && this.options.goalLabels[idx]) {
        return this.raphael.text(this.options.paddingLeftExtra, this.transY(goal), this.options.goalLabels[idx]).attr('text-anchor', 'end').attr('fill', color).attr('font-family', this.options.gridTextFamily).attr('font-size', this.options.gridTextSize);
      }
    };
